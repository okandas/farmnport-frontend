...
export default function FeedingProgramDetailPage({ params }: FeedingProgramDetailPageProps) {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["feeding-program", slug],
        queryFn: () => queryFeedingProgramBySlug(slug),
        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center px-4 pb-4">
                <div className="text-center max-w-md">
                    ...
                    <h2 className="text-2xl font-semibold mb-2">Feeding Program Not Found</h2>
                    <p className="text-muted-foreground mb-6">
                        We couldn&apos;t find the feeding program you&apos;re looking for.
                    </p>
                    <Link
