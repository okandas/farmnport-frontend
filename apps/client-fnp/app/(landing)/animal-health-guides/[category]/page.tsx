...
import { AnimalHealthCategoryClient } from "./AnimalHealthCategoryClient"
...
async function getCategoryProducts(category: string) {
    try {
        const res = await fetch(`${BaseURL}/animalhealth/category/${category}`, fetchOptions)
...
export default async function AnimalHealthCategoryPage({ params }: CategoryPageProps) {
