...
interface AgroCategoryClientProps {
    category: string
    categoryName: string
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <main className="flex-1">
                <ListingToolbar view={view} onViewChange={setView} filterSlot={<AgroChemicalFilterSidebar hideCategory={true} categorySlug={category} />} />
                {chemicalsLoading ? (
