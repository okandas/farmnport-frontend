      ...
      <div className="container">
        <div className="lg:flex lg:gap-8">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            {/* Contact card — mobile only, below details grid */}
            {!hasActiveBookings && (hasContactInfo || !user) && (
              <div className="lg:hidden rounded-lg border bg-card p-5 space-y-3">
          ...
          <aside className="hidden lg:block lg:w-72 shrink-0">
            <div className="sticky top-20 space-y-4 pt-4">
              {/* Contact card — hidden when buyer has active bookings or no contact info */}
              {!hasActiveBookings && (hasContactInfo || !user) && (
