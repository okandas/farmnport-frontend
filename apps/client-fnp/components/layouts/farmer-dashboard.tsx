...
import { ChevronRight, Eye, Layers, Tag, ArrowRight, Gavel, ShoppingBag } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { AuthenticatedUser } from "@/lib/schemas"
import { queryDashboardAggregates, queryPublishedFeedingPrograms, queryViewersList } from "@/lib/query"
...
export function FarmerDashboard({ user }: FarmerDashboardProps) {
  ...
  const otherAnimals = uniqueAnimals.filter(a => !isAnimalProduce(mainProduceSlug))
