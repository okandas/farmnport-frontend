...
import { ArrowRight, ChevronRight, Eye, FlaskConical, Layers } from "lucide-react"
import { AuthenticatedUser } from "@/lib/schemas"
import { queryDashboardAggregates, queryAnimalHealthCategories, queryPublishedFeedingPrograms, queryViewersList } from "@/lib/query"
        ...
        {!isLoading && mainProduceSlug && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
            ...
            <section>
              ...
              <Link href={`/buyers/${mainProduceSlug}`} className="block">
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border border-orange-200 dark:border-orange-800/30 rounded-lg p-6 hover:shadow-md transition-all">
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold">Find Buyers for {displayName}</h3>
                      <p className="text-sm text-muted-foreground">
                        {counterpartyCount > 0
                          ? `${counterpartyCount.toLocaleString()} buyers available to possibly buy your produce`
                          : `Browse buyers on the platform`}
                      </p>
                    </div>
