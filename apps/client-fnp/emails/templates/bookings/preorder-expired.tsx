...
export default function PreorderExpiredEmail({
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>Booking {bookingRef} expired — payment not received in time</Preview>
...
const pill: React.CSSProperties = { display: "inline-block", fontSize: "12px", fontWeight: "600", letterSpacing: "0.04em", color: "#94a3b8", border: "1px solid #94a3b8", borderRadius: "999px", padding: "4px 12px", margin: 0 }
