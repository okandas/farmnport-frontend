...
const pill: React.CSSProperties = { display: "inline-block", fontSize: "12px", fontWeight: "600", letterSpacing: "0.04em", color: "#0d9488", border: "1px solid #0d9488", borderRadius: "999px", padding: "4px 12px", margin: 0 }
