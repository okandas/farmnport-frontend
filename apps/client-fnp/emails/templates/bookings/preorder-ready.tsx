...
interface Props { name?: string; bookingRef?: string; productName?: string; quantity?: string | number; balanceDue?: string; bookingUrl?: string }
    ...
    <Html lang="en">
      ...
      <Body style={body}><Container style={container}>
        ...
        <Section style={content}>
          <Section style={pillWrapper}><Text style={pill}>Ready for Collection</Text></Section>
          <Text style={greeting}>Your order is ready, {name}!</Text>
...
const pill: React.CSSProperties = { display: "inline-block", fontSize: "12px", fontWeight: "600", letterSpacing: "0.04em", color: "#0d9488", border: "1px solid #0d9488", padding: "4px 12px", margin: 0 }
