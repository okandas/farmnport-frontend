...
export default function PreorderEventRejectedEmail({
  name = "Okandas",
  eventTitle = "shangure 1 farm — Other",
  produceName = "Triple Action Foliar liquid fertilizer",
  reason = "Only farm produce qualifies for bookings, not agrochemical products",
  eventUrl = "https://farmnport.com/account/booking-preorders",
}: Props) {
  return (
    <Html lang="en">
      <Head />
      <Preview>Your booking listing &quot;{eventTitle}&quot; was not approved</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Section style={buttonWrapper}>
              <Button href={eventUrl} style={buttonPrimary}>View your listings</Button>
            </Section>
          </Section>
