...
interface Props { name?: string; bookingRef?: string; productName?: string; quantity?: number; depositAmount?: string; deadlineHours?: number; bookingUrl?: string }
...
export default function PreorderConfirmedEmail({
  ...
  return (
    <Html lang="en">
      <Head />
      <Preview>Booking {bookingRef} confirmed — pay {depositAmount} to secure</Preview>
      <Body style={body}><Container style={container}>
        ...
        <Section style={content}>
          ...
          <Section style={buttonWrapper}><Button href={bookingUrl} style={button}>Pay Now</Button></Section>
          <Hr style={divider} />
...
const pill: React.CSSProperties = { display: "inline-block", fontSize: "12px", fontWeight: "600", letterSpacing: "0.04em", color: "#16a34a", border: "1px solid #16a34a", borderRadius: "999px", padding: "4px 12px", margin: 0 }
...
const depositText: React.CSSProperties = { fontSize: "14px", fontWeight: "600", color: "#ea580c", margin: 0 }
