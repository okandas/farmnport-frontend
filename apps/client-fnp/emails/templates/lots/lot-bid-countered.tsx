...
export default function LotBidCounteredEmail({
  name = "Okandas",
  counterName = "Okandas",
  ...
  counterPrice = "$2.75",
  total = "$275.00",
  bidUrl = "https://farmnport.com/account/bids/abc123",
}: LotBidCounteredEmailProps) {
  return (
    <Html lang="en">
      <Head />
      <Preview>Counter-offer received — {counterPrice}/{unit} on lot {lotSlug}</Preview>
      <Body style={body}>
