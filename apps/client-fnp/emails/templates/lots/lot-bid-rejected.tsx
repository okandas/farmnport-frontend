      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              There are other lots available — browse what's currently listed and place a new offer.
            </Text>
          </Section>
          ...
          <Section style={content}>
            <Section style={buttonWrapper}>
              <Button href="https://farmnport.com/lots" style={buttonPrimary}>Browse Available Lots</Button>
            </Section>
          </Section>
