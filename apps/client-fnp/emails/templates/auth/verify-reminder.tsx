        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              You signed up on farmnport but haven't verified your email yet. Verify now so you can:
            </Text>
            <Text style={listItem}>• Receive order alerts and booking requests from buyers</Text>
            <Text style={listItem}>• List your produce for sale — lots, bookings, and pre-orders</Text>
            <Text style={listItem}>• Get price updates and market news</Text>
            <Text style={listItem}>• Connect directly with farmers and buyers across Zimbabwe</Text>
          </Section>
...
const listItem: React.CSSProperties = { fontSize: "15px", lineHeight: "1.7", color: "#475569", margin: "0 0 4px", paddingLeft: "8px" }
