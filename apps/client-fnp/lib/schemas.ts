...
export const BuyerSeo: Record<string, string>  = {
  ...
  chillies: "Find chilli buyers in Zimbabwe. Connect with buyers purchasing fresh and dried chillies — black dombo, cayenne, and bird's eye — for processing, export, and retail.",
  "sugar-beans": "Find sugar bean buyers in Zimbabwe. Sell sugar beans to retailers, wholesalers, and food processors at competitive market prices.",
  "chickens-broilers": "Looking for broiler chicken buyers in Zimbabwe? Connect with buyers purchasing live and dressed broilers in bulk — abattoirs, fast-food chains, and retailers across all provinces.",
  "chickens-road-runner": "Find road runner chicken buyers in Zimbabwe. Sell free-range indigenous chickens to butcheries, hotels, and restaurants who pay premium prices.",
  "chickens-layers": "Connect with layer chicken buyers in Zimbabwe. Sell spent hens and laying hens to processors, butcheries, and livestock traders at fair market prices.",
  piglets: "Find piglet buyers in Zimbabwe. Sell weaner and feeder pigs directly to farmers and livestock traders at competitive prices.",
  "day-old-chicks": "Connect with day-old chick buyers in Zimbabwe. Sell broiler and layer DOCs to poultry farmers across all provinces.",
  "dairy-cattle": "Find dairy cattle buyers in Zimbabwe. Sell dairy cows, heifers, and in-calf cows to dairy farmers and livestock traders at competitive prices.",
  calves: "Connect with calf buyers in Zimbabwe. Sell weaner and feeder calves to feedlot operators, farmers, and livestock traders.",
  "maize-corn": "Find maize buyers in Zimbabwe. Sell your maize harvest to millers, GMB, traders, and animal feed manufacturers at current market prices.",
  "groundnuts-peanuts": "Connect with groundnut buyers in Zimbabwe. Sell peanuts to butter manufacturers, oil pressers, confectioneries, and export traders.",
  "lucerne-alfalfa": "Find lucerne buyers in Zimbabwe. Sell lucerne bales to dairy farmers, horse stables, and livestock feedlots.",
  "ostrich-meat": "Connect with ostrich meat buyers in Zimbabwe. Sell ostrich to processors and export traders.",
  "duck-meat": "Find duck meat buyers in Zimbabwe. Sell dressed duck to restaurants, retailers, and specialty food suppliers.",
  "turkey-meat": "Connect with turkey meat buyers in Zimbabwe. Sell dressed turkey to hotels, restaurants, and retailers especially during festive seasons.",
  "guinea-fowl": "Find guinea fowl buyers in Zimbabwe. Sell live and dressed guinea fowl to restaurants, markets, and specialty food buyers.",
  "flowers-cut-flowers": "Connect with cut flower buyers in Zimbabwe. Sell roses, proteas, and cut flowers to florists, event companies, and export markets.",
  okra: "Find okra buyers in Zimbabwe. Sell fresh okra to retailers, restaurants, and food processors.",
  eggplant: "Find eggplant buyers in Zimbabwe. Sell fresh eggplant to supermarkets, restaurants, and wholesale markets.",
  sweetcorn: "Connect with sweetcorn buyers in Zimbabwe. Sell fresh sweetcorn to retailers, food processors, and wholesale markets.",
  silage: "Find silage buyers in Zimbabwe. Sell silage bales to dairy farmers and livestock feedlots.",
  kapenta: "Connect with kapenta buyers in Zimbabwe. Sell dried and fresh kapenta to retailers, wholesalers, and fish traders.",
  bream: "Find bream buyers in Zimbabwe. Sell fresh bream to restaurants, fish markets, and retailers.",
  // Fruits
...
export const FarmerSeo: Record<string, string>  = {
  ...
  chillies: "Find chilli farmers in Zimbabwe. Buy fresh and dried chillies — black dombo, cayenne, and bird's eye — directly from growers for processing and retail.",
  "sugar-beans": "Connect with sugar bean farmers in Zimbabwe. Buy sugar beans directly from growers at farm-gate prices for retail and wholesale.",
  "chickens-broilers": "Find broiler chicken farmers in Zimbabwe. Buy live and dressed broilers directly from poultry producers — bulk orders welcome.",
  "chickens-road-runner": "Connect with road runner chicken farmers in Zimbabwe. Buy free-range indigenous chickens directly from smallholder and commercial farmers.",
  "chickens-layers": "Find layer chicken farmers in Zimbabwe. Buy laying hens and spent hens directly from poultry producers.",
  piglets: "Connect with piglet farmers in Zimbabwe. Buy weaner and feeder pigs directly from breeders at competitive prices.",
  "day-old-chicks": "Find day-old chick suppliers in Zimbabwe. Buy broiler and layer DOCs directly from hatcheries and breeders.",
  "dairy-cattle": "Connect with dairy cattle farmers in Zimbabwe. Buy dairy cows, heifers, and in-calf cows directly from trusted producers.",
  calves: "Find calf farmers in Zimbabwe. Buy weaner and feeder calves directly from cattle farmers and livestock producers.",
  "maize-corn": "Connect with maize farmers in Zimbabwe. Buy quality maize directly from growers for milling, animal feed, or resale at current market prices.",
  "groundnuts-peanuts": "Find groundnut farmers in Zimbabwe. Buy peanuts directly from growers for butter manufacturing, oil pressing, and export.",
  "lucerne-alfalfa": "Connect with lucerne farmers in Zimbabwe. Buy lucerne bales directly from growers for dairy and livestock feeding.",
  "ostrich-meat": "Find ostrich farmers in Zimbabwe. Buy ostrich directly from producers for meat, leather, and feather processing.",
  "duck-meat": "Connect with duck farmers in Zimbabwe. Buy dressed duck directly from poultry producers for restaurants and retail.",
  "turkey-meat": "Find turkey farmers in Zimbabwe. Buy dressed turkey directly from breeders especially for festive seasons.",
  "guinea-fowl": "Connect with guinea fowl farmers in Zimbabwe. Buy live and dressed guinea fowl directly from producers.",
  "flowers-cut-flowers": "Find cut flower farmers in Zimbabwe. Buy roses, proteas, and cut flowers directly from growers for floristry and events.",
  okra: "Connect with okra farmers in Zimbabwe. Buy fresh okra directly from growers for retail and food processing.",
  eggplant: "Find eggplant farmers in Zimbabwe. Buy fresh eggplant directly from growers for supermarkets and restaurants.",
  sweetcorn: "Connect with sweetcorn farmers in Zimbabwe. Buy fresh sweetcorn directly from growers for retail and processing.",
  silage: "Find silage producers in Zimbabwe. Buy silage bales directly from farmers for dairy and livestock feeding.",
  kapenta: "Connect with kapenta fishermen in Zimbabwe. Buy dried and fresh kapenta directly from Lake Kariba fishermen.",
  bream: "Find bream fishermen in Zimbabwe. Buy fresh bream directly from fishermen for restaurants and fish markets.",
  // Fruits
