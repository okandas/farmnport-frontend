...
export default function ActiveBuyersPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["active-buyers", page],
    queryFn: () => authorizedHTTPClient.get(`/v1/views/admin/top-viewers?page=${page}&limit=${PAGE_SIZE}&type=buyer`),
    select: (res) => res.data,
  ...
  return (
    <DashboardShell>
      ...
      <DashboardHeader heading="Most Active Buyers" text="Buyers actively sourcing from the platform" />
