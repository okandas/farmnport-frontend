...
export default function ViewedBuyersPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["viewed-buyers", page],
    queryFn: () => authorizedHTTPClient.get(`/v1/views/admin/recent-viewed?page=${page}&limit=${PAGE_SIZE}&type=buyer`),
    select: (res) => res.data,
  ...
  return (
    <DashboardShell>
      ...
      <DashboardHeader heading="Most Viewed Buyers" text="Buyer profiles being viewed by farmers and other buyers" />
