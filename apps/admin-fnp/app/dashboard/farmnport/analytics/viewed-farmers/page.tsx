...
export default function ViewedFarmersPage() {
  ...
  const items = (data?.data?.top_viewed ?? []).filter((c: any) => c.type === "farmer")
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {isLoading ? (
        ...
        <FullViewTable title="Most Viewed Farmers" subtitle="Farmer profiles being viewed by buyers and other farmers" items={items} countLabel="Views" idKey="viewed_id" linkPrefix="contact" />
      )}
    </div>
  )
}
