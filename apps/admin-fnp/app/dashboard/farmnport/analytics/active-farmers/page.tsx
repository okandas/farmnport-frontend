...
export default function ActiveFarmersPage() {
  ...
  const items = (data?.data?.top_viewers ?? []).filter((v: any) => v.type === "farmer")
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {isLoading ? (
        ...
        <FullViewTable title="Most Active Farmers" subtitle="Farmers actively looking at other profiles" items={items} countLabel="Viewed" idKey="user_id" linkPrefix="viewer" />
      )}
    </div>
  )
}
