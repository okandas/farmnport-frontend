...
export function updateAgroChemicalCategory(data: { id: string; name: string; short_description: string; description: string; image_src?: string }) {
...
export function updateFarmProduceCategory(data: { slug: string; name: string; description: string; image_src?: string }) {
  const url = `${baseUrl}/farmproducecategories/${data.slug}`
  return api.put(url, { name: data.name, description: data.description, image_src: data.image_src || "" })
}
...
export function updateFarmProduce(data: { slug: string; name: string; description: string; category_id: string; category_slug: string; lots_enabled: boolean; image_src?: string }) {
...
export function updateAnimalHealthCategory(data: { id: string; name: string; short_description: string; description: string; image_src?: string }) {
...
export function updateFeedCategory(data: { id: string; name: string; short_description: string; description: string; image_src?: string }) {
